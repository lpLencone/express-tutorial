const products = [
  ...
  },
  {
    ...
    name: 'amber sofa',
    image:
      'https://dl.airtable.com/.attachments/3245c726ee77d73702ba8c3310639727/f000842b/product-4.jpg',
    price: 12.99,
    desc: `lorem ipslum market cap fan struggle average make it better data javacript description productive iron shott triple inferno shudder morbid trickle sup man never mind`
  }
]
const people = [
  { id: 1, name: 'john' },
